...
class profile_apache::params {
  ...
  $php7_packages = ['php7.1-common','php7.1-cli', 'pdftk','dnsutils','fop', 'imagemagick', 'dnsutils', 'curl', 'php-pear', 'build-essential', 'php7.1-dev', 'libapache2-mod-php7.1', 'php7.1-fpm']
