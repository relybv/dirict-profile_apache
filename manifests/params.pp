...
class profile_apache::params {
  ...
  $php7_packages = ['php7.1','php7.1-fpm','php7.1-common','php7.1-cli', 'pdftk','dnsutils','fop', 'imagemagick', 'dnsutils', 'curl', 'php-pear', 'build-essential', 'php7.1-dev', 'php7.1-xml','libsodium-dev','php7.1-bz2','php7.1-curl','php7.1-gd','php-imagick','php7.1-imap','php-sodium','php7.1-mbstring','php7.1-mcrypt','php7.1-soap','php7.1-zip']
