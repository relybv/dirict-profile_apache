...
#
# Usage:
# Ubuntu / Debian: wget https://raw.githubusercontent.com/relybv/dirict-profile_apache/master/files/bootstrap.sh; bash bootstrap.sh
#
# Red Hat / CentOS: curl https://raw.githubusercontent.com/relybv/dirict-profile_apache/master/files/bootstrap.sh -o bootstrap.sh; bash bootstrap.sh
